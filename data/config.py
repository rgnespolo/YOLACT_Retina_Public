...
# multi retina
# train_images = Path(r'C:\Users\MGS\Documents\GitHub\YOLACT_Retina\data\final_dataset\images')
# train_info = Path(r'C:\Users\MGS\Documents\GitHub\YOLACT_Retina\data\final_dataset\annotations\instances_default.json')
# valid_images = Path(r'C:\Users\MGS\Documents\GitHub\YOLACT_Retina\data\final_dataset\images')
# valid_info = Path(r'C:\Users\MGS\Documents\GitHub\YOLACT_Retina\data\final_dataset\annotations\instances_default.json')
# test_images = Path(r'C:\Users\MGS\Documents\GitHub\YOLACT_Retina\data\final_dataset\images')
# test_info = Path(r'C:\Users\MGS\Documents\GitHub\YOLACT_Retina\data\final_dataset\annotations\instances_default.json')
# #for test purpose. cocosplit used to divide dataset into train/valid in folder multi_retina_sep


# retina detachment only
train_images = Path(r'C:\Users\MGS\Documents\GitHub\YOLACT_Retina\data\detachment_dataset\images')
train_info = Path(r'C:\Users\MGS\Documents\GitHub\YOLACT_Retina\data\detachment_dataset\annotations\instances_default.json')
valid_images = Path(r'C:\Users\MGS\Documents\GitHub\YOLACT_Retina\data\detachment_dataset\images')
valid_info = Path(r'C:\Users\MGS\Documents\GitHub\YOLACT_Retina\data\detachment_dataset\annotations\instances_default.json')
test_images = Path(r'C:\Users\MGS\Documents\GitHub\YOLACT_Retina\data\detachment_dataset\images')
test_info = Path(r'C:\Users\MGS\Documents\GitHub\YOLACT_Retina\data\detachment_dataset\annotations\instances_default.json')

# train_images = Path(r'C:\Users\MGS\Documents\GitHub\PhD_Nespolo\Vitrectomy\yolact-master_Retina_Soc_full_annotations\data\multi_all_emily\images')
# train_info = Path(r'C:\Users\MGS\Documents\GitHub\PhD_Nespolo\Vitrectomy\yolact-master_Retina_Soc_full_annotations\data\multi_all_emily\annotations\train.json')
# valid_images = Path(r'C:\Users\MGS\Documents\GitHub\PhD_Nespolo\Vitrectomy\yolact-master_Retina_Soc_full_annotations\data\multi_all_emily\images')
# valid_info = Path(r'C:\Users\MGS\Documents\GitHub\PhD_Nespolo\Vitrectomy\yolact-master_Retina_Soc_full_annotations\data\multi_all_emily\annotations\valid.json')
# test_images = Path(r'C:\Users\MGS\Documents\GitHub\PhD_Nespolo\Vitrectomy\yolact-master_Retina_Soc_full_annotations\data\multi_all_emily')
# test_info = Path(r'C:\Users\MGS\Documents\GitHub\PhD_Nespolo\Vitrectomy\yolact-master_Retina_Soc_full_annotations\data\multi_all_emily\annotations\valid.json')
...
multi_retina = dataset_base.copy({
    'name': 'multi_retina',
    ...
    'test_info': test_info,
    'has_gt': True,
    'class_names': ('Vitrector_tooltip', 'Membrane_forceps_tooltip', 'Endolaser_tooltip', 'Optic_disc', 'Fovea',
...
retinal_detachment = dataset_base.copy({
    ...
    'valid_info': valid_info,
    'has_gt': True,
    'class_names': ('retinal_detachment')
    #'class_names': ('veins', 'optic_disc', 'laser_done', 'macula', 'laser', 'tool', 'tooltip')
})
...
fpn_base = Config({
    ...
    # Whether to raadd relu to the regular layers
...
coco_base_config = Config({
    ...
    # Randomize hue, vibrance, etc.augment_random_sample_crop
...
yolact_base_config = coco_base_config.copy({
    ...
    'name': 'retinal_detachment',
    # # Dataset stuff
    #'dataset': multi_retina,
    'dataset': retinal_detachment,
    # 'dataset': coco2017_dataset,
    #'num_classes': len(multi_retina.class_names) + 1,
    'num_classes': len(retinal_detachment.class_names) + 1,  # len(coco2017_dataset.class_names) + 1,
    # Dataset stuff
