...
#python train.py --config=yolact_base_config --batch_size=5 --save_interval=500 --resume=interrupt --validation_size=5
...
def train():
    ...
    #each sample starts with zero
    sample_weights = [0] * len(dataset)
    #accordingly to data distribution, oversampling the minority class
    class_weights = [293/201, 293/180, 293/194, 293/293, 293/175, 293/18, 293/24, 293/8, 293/25, 293/161, 293/212, 293/27, 293/42, 293/15]
    ...
    #shuffle needs to be false due to the sampler
